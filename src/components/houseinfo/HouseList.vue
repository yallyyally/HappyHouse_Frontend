    ...
    <b-container>
      ...
      <template #default="{ hide }">
        <div class="p-3">
          ...
          <specific-house-map :subway="subway" :bus="bus" :publicbicycle="publicbicycle" :school="school" :kindergarten="kindergarten" :selectedHouseDealLatLng = "selectedHouseDealLatLng"></specific-house-map>

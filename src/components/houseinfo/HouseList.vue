    ...
    <b-container>
      ...
      <template #default="{ hide }">
        <div class="p-3">
          ...
          <specific-house-map :subway="subway" :bus="bus" :publicbicycle="publicbicycle" :school="school" :selectedHouseDealLatLng = "selectedHouseDealLatLng"></specific-house-map>
...
export default{
    ...
    computed:{
        ...mapGetters(['subway','bus','publicbicycle','school','selectedHouseDealLatLng','cameraPos',"houses",'selectedHouse','selectedHouseDeal','avgDealAmount','selectedHouseDealAmount','selectedHouseDealDate'])
    },
    created(){

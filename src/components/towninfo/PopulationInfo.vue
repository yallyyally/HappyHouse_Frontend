  ...
  <b-container v-if="selectComplete">
    ...
    <div class="content">
      ...
      <h4>
        ...
        >의 인구는 <strong>{{ totalPopulation }}</strong
        >명 입니다.
      </h4>
      ...
      <b-row style="margin-top: 50px">
        ...
        <b-col>
          <h5>
            <strong>{{ selectedGu }}</strong
            >의 인구는 <strong>{{ totalMoveInOut }}명</strong>
            <strong><span v-if="increase"> 증가</span> <span v-else>감소</span></strong
            >하였습니다.
          </h5>
        ...
        <!-- 가구별 인구수 -->
        <b-col
          ><strong>가구별 인원</strong>

          <b-form-select
            @change="changeDong()"
            v-model="tmpSelectedDong"
            :options="dongs"
            class="mb-3"
          >
